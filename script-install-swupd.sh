...
sudo swupd bundle-add desktop vlc htop sysadmin-basic wine lutris && flatpak install flathub com.discordapp.Discord com.valvesoftware.Steam org.flameshot.Flameshot
